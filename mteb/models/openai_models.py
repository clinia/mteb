...
text_embedding_3_small_256 = ModelMeta(
    name="openai/text-embedding-3-small-256",
    revision="2",
    release_date="2024-01-25",
    languages=None,  # supported languages not specified
    loader=partial(
...
text_embedding_3_small_1024 = ModelMeta(
    name="openai/text-embedding-3-small-1024",
    revision="2",
    release_date="2024-01-25",
    languages=None,  # supported languages not specified
    loader=partial(
...
text_embedding_3_large_256 = ModelMeta(
...
text_embedding_3_large_512 = ModelMeta(
    name="openai/text-embedding-3-large-512",
    revision="2",
    release_date="2024-01-25",
    languages=None,  # supported languages not specified
    loader=partial(
...
text_embedding_3_large_768 = ModelMeta(
    name="openai/text-embedding-3-large-768",
    revision="2",
    release_date="2024-01-25",
    languages=None,  # supported languages not specified
    loader=partial(
...
text_embedding_3_large_1024 = ModelMeta(
...
text_embedding_3_large_1536 = ModelMeta(
    name="openai/text-embedding-3-large-1536",
    revision="2",
    release_date="2024-01-25",
    languages=None,  # supported languages not specified
    loader=partial(
